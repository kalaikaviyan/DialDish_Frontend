        ...
        NavigationBarItem(
            ...
            onClick = {
                if (currentSelected != "Orders") {
                    ...
                    val intent = Intent(context, Class.forName("com.simats.directdine.owner.OOrdersActivity"))
                    intent.flags = Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
                    val options = android.app.ActivityOptions.makeCustomAnimation(context, android.R.anim.fade_in, android.R.anim.fade_out).toBundle()
                    context.startActivity(intent, options)
                }
        ...
        NavigationBarItem(
            ...
            onClick = {
                if (currentSelected != "Menu") {
                    ...
                    val intent = Intent(context, Class.forName("com.simats.directdine.owner.OMenuActivity"))
                    intent.flags = Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
                    val options = android.app.ActivityOptions.makeCustomAnimation(context, android.R.anim.fade_in, android.R.anim.fade_out).toBundle()
                    context.startActivity(intent, options)                }
            },
        ...
        NavigationBarItem(
            ...
            onClick = {
                if (currentSelected != "Profile") {
                    ...
                    val intent = Intent(context, Class.forName("com.simats.directdine.owner.OProfileActivity"))
                    intent.flags = Intent.FLAG_ACTIVITY_REORDER_TO_FRONT
                    val options = android.app.ActivityOptions.makeCustomAnimation(context, android.R.anim.fade_in, android.R.anim.fade_out).toBundle()
                    context.startActivity(intent, options)                }
            },
