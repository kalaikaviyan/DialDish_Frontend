...
fun LegalContent() {
    ...
    InfoSection("1. Handcash Trust Protocol", "As a Delivery Partner, any Handcash collected from users technically belongs to the Stall Owner. directdine maintains a permanent, unalterable digital ledger of your active balance. You must surrender this amount, minus negotiated expenses like petrol, at the end of your shift.")
    ...
    InfoSection("4. Location Tracking Privacy", "directdine strictly respects your privacy. We only pull and broadcast your GPS coordinates when you are actively toggled 'ONLINE'. Once offline, tracking instantly and permanently ceases.")
}
