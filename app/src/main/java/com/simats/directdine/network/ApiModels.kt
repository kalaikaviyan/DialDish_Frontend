...
data class StaffBalanceItem(
    val id: Int,
    val staff_id_code: String,
    val name: String,
    val phone: String,
    val email: String,
    val active_cash: Double,
...
data class ToggleAttendanceRequest(val staff_id: Int, val is_present: Boolean)
data class ToggleAttendanceResponse(val status: String, val message: String?)
