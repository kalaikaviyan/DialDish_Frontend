...
interface DialDishApi {
    ...
    // Add inside your DialDishApi interface
    ...
    // Add inside DialDishApi interface
    ...
    // Add this inside the DialDishApi interface
    ...
    // --- Add this ANYWHERE inside DialDishApi.kt ---
